...
export default function Footer() {
  return (
    <footer id="footer-board" className="w-full py-4 bg-transparent border-t border-white/10 relative z-10 mt-auto">
      <div className="flex flex-col items-center justify-center px-4 max-w-[1440px] mx-auto gap-2">
        
        {/* Top Text */}
        <div className="font-inter text-[11px] md:text-[12px] text-yellow-500/80 text-center tracking-widest uppercase">
        ...
        <div className="flex gap-5 mt-0.5">
          <a
            ...
            className="text-slate-400 hover:text-yellow-400 hover:scale-110 transition-all duration-300 flex items-center justify-center"
